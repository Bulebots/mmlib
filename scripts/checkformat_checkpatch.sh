...
./checkpatch.pl --terse --no-tree --max-line-length=80 --ignore ARRAY_SIZE,BOOL_BITFIELD,LEADING_SPACE,SPDX_LICENSE_TAG,SPLIT_STRING,USE_NEGATIVE_ERRNO,VOLATILE --file ./*.[ch]
